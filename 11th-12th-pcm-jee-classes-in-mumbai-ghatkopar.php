...
<head>
<!-- Page Title -->
<title>Mumbai's Best Coaching Institute | XI + XII (PCMB) + NEET</title>

<!-- Meta Tags -->
<meta name="viewport" content="width=device-width,initial-scale=1.0"/>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"/>
<meta name="description" content="Mumbai's leading Coaching Institute to Enroll for XI + XII (PCMB) + NEET. Best Facutly with highest quality infrastructure. Library Access. Enroll Now !!" />
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12  text-center">
              <span class="title text-white">XI + XII (PCMB) + NEET</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service">
              ...
              <h3 class="text-theme-colored">XI + XII (PCMB) + NEET</h3>
