...
<head>
<!-- Page Title -->
<title>Crash Course « MHT –CET « NEET « JEE | IITMinds™</title>

<!-- Meta Tags -->
<meta name="viewport" content="width=device-width,initial-scale=1.0"/>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"/>
<meta name="description" content="LearnPress | Education & Courses HTML Template" />
<meta name="keywords" content="Mumbai's leading Coaching Institute in Gharkopar. Best Facutly with highest quality infrastructure. Library Access. Enroll Now for MHT-CET course." />
<meta name="author" content="IITMind" />
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <ol class="breadcrumb text-left text-black mt-10">
                ...
                <li class="active text-gray-silver">MH - CET</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service">
              ...
              <h3 class="text-theme-colored">MH - CET</h3>
              <h5><em></em></h5>
              <p></p>
              <p></p>
              <div class="row">
              ...
              <div class="widget">
                ...
                <div class="services-list">
                  <ul class="list list-border">
                    ...
                    <li class="active"><a href="mh-cet.php">MH - CET</a></li>
                  </ul>
                </div>
              </div>
